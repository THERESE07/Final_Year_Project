...
import { analyticsAPI, notificationsAPI } from '../../api/client';
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
        ...
        <div className="card flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-2xl font-bold text-gray-900">2025B</p>
            <p className="text-xs text-gray-400">Season ends March 2026</p>
          </div>
        </div>
      </div>
