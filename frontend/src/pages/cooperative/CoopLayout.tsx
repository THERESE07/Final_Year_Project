...
import { LayoutDashboard, Users, Package, FileText, Shield, Bell, User, LogOut, Menu, Search } from 'lucide-react';
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        <header className="bg-white border-b border-gray-100 px-4 py-3 flex items-center gap-3 flex-shrink-0">
          ...
          <div className="flex items-center gap-3 ml-auto">
            <Link to="/cooperative/notifications" className="relative p-2 text-gray-500 hover:text-gray-700 hover:bg-gray-100 rounded-lg">
